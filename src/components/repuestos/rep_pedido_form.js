...
const PedidoForm = ({pedido, setPedido}) => {
    ...
    const [datos, setDatos] = useState({
        ...
        fecha_prevista_entrega: pedido ? pedido.fecha_prevista_entrega : (hoy.getFullYear() + '-'+String((hoy.getMonth() + 1) % 12 + 1).padStart(2, '0') + '-' +String(hoy.getDate() === 31 ? (hoy.getDate() - 1) : hoy.getDate()).padStart(2, '0')),  
    ...
    useEffect(()=>{
        pedido && setDatos({
            ...
            fecha_prevista_entrega: pedido ? pedido.fecha_prevista_entrega :`${hoy.getFullYear()}-${String(hoy.getMonth() + 1).padStart(2, '0')}-${String(hoy.getDate()).padStart(2, '0')}`,
