...
const StandChart2 = ({montaje, posiciones, gap, fleje}) => {
    ...
    useEffect(()=>{
        ...
        function draw_BD(stand, i) {
            ...
            let Dext, Df, Dc; 
            let Ancho;
            let alfa, alfa1, alfa2, alfa3;
            let pos;
            let xc, xc1, xc2, xc3, yc, yc1, yc2, yc3, x0, y0, x1, y1, x2, y2, x3, y3, x4, y4, x5, y5, x6, y6;
            let c;
            
            // Rodillo inferior
            switch (roll_i.tipo_plano){
                case 'BD_INF':
                    ...
                    // Calculos
                    xc = 0;
                    yc = pos_inf +R; //AxisPos0_i + Df/2 + R;
                ...
                case 'BD_W_INF':
                    ...
                    yc1 = pos_inf + R1; //AxisPos0_i + Df/2 + R1;
            ...
            switch (roll_s.tipo_plano){
                case 'BD_SUP':
                    ...
                    pos = pos_sup; //AxisPos0_s - Dext / 2;
                    // const pos_i = roll_i.parametros.Df/2 + AxisPos0_i;
                    c = 60; 

                    if (pos<= pos_inf+fleje.espesor) {
                    c = c - (pos_inf - pos + fleje.espesor);
                    pos= pos_inf + fleje.espesor;
                    }
        ...
        function draw_IS(stand,i){
                ...
                let Df, Dc, Dsup, Dext, R1, R2, alfa1, alfa2, alfa3, Ancho, Hc;
    
                switch (roll_Lat.tipo_plano) {
                    case 'IS-1':
                        // Parametros
                        ...
                        // Calculos
                        pos_h = pos_ancho; //170 + AxisPos0_Lat_Ancho - Df;
                        pos_v = pos_alto; //AxisPos0_Lat_Alto - 40;
                    ...
                    case 'IS2-3':
                        ...
                        // Calculos
                        pos_h = pos_ancho; //170 + AxisPos0_Lat_Ancho - Df;
                        pos_v = pos_alto; //AxisPos0_Lat_Alto - 270;
                        xc = -pos_h/2 + R2;
                        yc = pos_v;
                        x1 = xc - R2 + (Dsup-Df)/2;
                        let b = -2*yc;
        ...
        function draw_W(stand, i){
            ...
            // Rodillos
            const roll_Lat_Operador = stand.rodillos.filter(r => r.eje=='LAT_OP')[0]; //stand.rodillos[0];
            const roll_Lat_Motor = stand.rodillos.filter(r => r.eje=='LAT_MO')[0]; //stand.rodillos[1];
            const roll_Inf = stand.rodillos.filter(r => r.eje=='INF')[0]; //stand.rodillos[2];
