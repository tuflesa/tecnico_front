//Modal que abrimos en las lineas de un parte para ver fechas de acción y quién está trabajando en la tarea
...
const LineasPartesMov = ({tarea, handleCloseList, show, parte}) => {
    ...
    useEffect(()=>{
        tarea && axios.get(BACKEND_SERVER + `/api/mantenimiento/lineas_parte_contrabajador/?tarea=${tarea.id}&parte=${parte.id}`,{
            headers: {
